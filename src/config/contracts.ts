...
export const PODIUM_CONTRACT_CONFIG = {
  CONTRACT: "0x78E84851343DD61594a6588A38d1B154435B5dB2" as `0x${string}`,
  BRND_TOKEN: "0x41Ed0311640A5e489A90940b1c33433501a21B07" as `0x${string}`,
  CHAIN_ID: 8453, // Base mainnet
} as const;
